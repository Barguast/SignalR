...
QUnit.asyncTimeoutTest("Connection times out when initialize not received.", testUtilities.defaultTestTimeout, function (end, assert, testName) {
    ...
    // Reduce the connection timeout time
    connection.transportTimeOut = 1000;
